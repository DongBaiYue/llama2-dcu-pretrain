...
case "$DEVICE" in
    dcu)
        CONFIG_FILE="configs/pt/train_llama3_8b.yaml"
        LOG_FILE="logs/pt/llama3-8b.log"
        DIST_LOG_DIR="logs/pt/llama3-8b.dist"
        ;;
    gpu)
        CONFIG_FILE="configs/pt/train_llama3_8b.yaml"
        LOG_FILE="logs/pt/llama3-8b_gpu.log"
        DIST_LOG_DIR="logs/pt/llama3-8b_gpu.dist"
        ;;
    *)
