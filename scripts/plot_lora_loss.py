"""LoRA SFT Loss 对比绘图脚本: DCU vs GPU

用法: python3 scripts/plot_lora_loss.py
输出: docs/lora_loss_compare.png
"""
import re
import os
import numpy as np
...
steps_dcu, loss_dcu = extract_loss(os.path.join(PROJECT_ROOT, "logs", "lora", "13b.log"))
steps_gpu, loss_gpu = extract_loss(os.path.join(PROJECT_ROOT, "logs", "lora", "13b_gpu.log"))
...
fig.suptitle("Llama-2-13B LoRA SFT Loss: DCU vs GPU", fontsize=16, fontweight='bold', y=0.96)
...
out_path = os.path.join(PROJECT_ROOT, "docs", "lora_loss_compare.png")
