...
case "$DEVICE" in
    dcu)
        CONFIG_FILE="configs/sft/train_llama3_70b.yaml"
        LOG_FILE="logs/sft/llama3-70b.log"
        DIST_LOG_DIR="logs/sft/llama3-70b.dist"
        ;;
    gpu)
        CONFIG_FILE="configs/sft/train_llama3_70b.yaml"
        LOG_FILE="logs/sft/llama3-70b_gpu.log"
        DIST_LOG_DIR="logs/sft/llama3-70b_gpu.dist"
        ;;
    *)
