...
case "$DEVICE" in
    dcu)
        CONFIG_FILE="configs/lora/train_llama3_100b.yaml"
        LOG_FILE="logs/lora/llama3-100b_${NNODES}node.log"
        DIST_LOG_DIR="logs/lora/llama3-100b_${NNODES}node.dist"
        VENV_DIR="$PROJECT_ROOT/../py310"
        ;;
    gpu)
        CONFIG_FILE="configs/lora/train_llama3_100b.yaml"
        LOG_FILE="logs/lora/llama3-100b_${NNODES}node_gpu.log"
        DIST_LOG_DIR="logs/lora/llama3-100b_${NNODES}node_gpu.dist"
